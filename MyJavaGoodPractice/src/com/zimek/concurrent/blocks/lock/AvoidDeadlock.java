...
public class AvoidDeadlock implements ConfirmingMicroBlogNode {
	...
	public AvoidDeadlock(String ident_) {
		ident = ident_;
	}
	...
	public static void main(String[] a) {
		final AvoidDeadlock local = new AvoidDeadlock("localhost:8888");
		final AvoidDeadlock other = new AvoidDeadlock("localhost:8988");
